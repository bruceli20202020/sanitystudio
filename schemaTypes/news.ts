export default {
  ...
  fields: [
    ...
    { name: 'author_en', title: '作者英文', type: 'string' },
    { name: 'author_de', title: '作者德文', type: 'string' },
    { name: 'tags', title: '标签', type: 'array', of: [{ type: 'string' }] },
    { name: 'tags_en', title: '标签英文', type: 'array', of: [{ type: 'string' }] },
    { name: 'tags_de', title: '标签德文', type: 'array', of: [{ type: 'string' }] },
